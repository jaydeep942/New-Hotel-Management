...
<body class="bg-[#F8F5F0] min-h-screen">
    ...
    <aside id="sidebar" class="w-72 bg-white fixed h-full border-r border-gray-100 px-6 py-8 z-[55] overflow-y-auto transition-transform duration-300 -translate-x-full lg:translate-x-0">
        ...
        <nav class="space-y-2">
            ...
            <a href="profile.php" class="sidebar-link flex items-center space-x-4 p-4 rounded-2xl text-gray-500 hover:text-maroon group text-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12 mb-12">
                ...
                <div class="lg:col-span-2 bg-white rounded-[40px] p-10 premium-shadow">
                    <div class="flex justify-between items-center mb-8">
                        ...
                        <span class="px-4 py-1.5 bg-teal/10 text-teal rounded-full text-xs font-bold uppercase tracking-widest">Day <?php echo $currentDay; ?> of <?php echo $totalNights; ?></span>
                        <?php else: ?>
                        <span class="px-4 py-1.5 bg-gold/10 text-gold rounded-full text-xs font-bold uppercase tracking-widest"><?php echo $isLive ? 'Stay Active' : 'Waiting for Check-in'; ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="w-full bg-gray-100 h-4 rounded-full overflow-hidden mb-10">
                        <div class="bg-teal h-full rounded-full transition-all duration-1000" style="width: <?php echo $hasBooking ? $progressPercent : 0; ?>%"></div>
                    </div>
                ...
                <div class="bg-white rounded-[40px] p-10 premium-shadow overflow-hidden relative">
                    <div class="flex justify-between items-center mb-8">
                        ...
                        <a href="services.php" class="text-xs font-bold text-gold hover:underline">View Menu</a>
                    </div>
