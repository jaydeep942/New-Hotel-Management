            ...
            <div class="max-w-[1600px] mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center space-x-12">
                    ...
                    <div class="hidden xl:flex items-center space-x-1">
                        ...
                        <a href="cleaning.php" class="nav-link active flex items-center px-6 py-3.5 rounded-2xl text-[13px] font-bold transition-all">
                            <span>Cleaning</span>
                        </a>
                    ...
                    <div class="relative group">
                        <div class="flex items-center space-x-4 cursor-pointer py-1">
                            <div class="hidden sm:block text-right">
                                ...
                                <p class="text-[10px] uppercase font-black text-gold tracking-widest mt-1 opacity-70">Premium Member</p>
                            </div>
        ...
        <div id="mobileMenu" class="fixed inset-0 z-[100] hidden">
            ...
            <div id="mobileDrawer" class="absolute inset-y-0 right-0 w-80 bg-white shadow-2xl p-8 transform translate-x-full transition-transform duration-300 overflow-y-auto h-full">
                ...
                <nav class="space-y-3">
                    ...
                    <a href="cleaning.php" class="sidebar-link active flex items-center space-x-4 p-4 rounded-2xl font-bold">
