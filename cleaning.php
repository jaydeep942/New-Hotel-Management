...
<body class="bg-[#F8F5F0] min-h-screen">
    ...
    <aside id="sidebar"
        ...
        <nav class="space-y-2">
            ...
            <a href="profile.php"
                class="sidebar-link flex items-center space-x-4 p-4 rounded-2xl text-gray-500 hover:text-maroon group text-sm"><i
                    class="fas fa-user-circle w-5"></i><span class="font-semibold">Manage Profile</span></a>
    ...
    <main class="flex-1 lg:ml-72 p-4 md:p-8">
        ...
        <div class="max-w-4xl mx-auto text-center py-20">
            <div class="bg-white rounded-[60px] p-16 premium-shadow border border-gray-50">
                <div class="mb-12">
                    <p class="text-[10px] uppercase tracking-[6px] font-extrabold text-gold mb-4">Current Suite</p>
                    <h2 class="text-6xl font-bold maroon-text mb-6"><?php echo $currentSuite; ?></h2>
                    <p class="text-gray-400 text-lg">Maintaining Excellence in Your Sanctuary</p>
                </div>

                <div id="requestContainer" class="space-y-12">
                    <div
                        class="w-48 h-48 bg-teal/5 rounded-full flex items-center justify-center mx-auto border-4 border-teal/10">
                ...
                <!-- Success Message -->
                <div id="successMsg" class="hidden py-10 success-box">
                    <div
                        class="w-32 h-32 bg-gold rounded-full flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-gold/30">
                        <i class="fas fa-check text-white text-5xl"></i>
                    </div>
                    <h3 class="text-3xl font-bold maroon-text mb-4">Request Dispatched</h3>
                    <p class="text-gray-400 leading-relaxed mb-10">Housekeeping has been notified of your request for
                        <?php echo $currentSuite; ?>.<br>A clean and fresh environment is on its way.</p>
                    <button onclick="resetRequest()" class="text-teal font-bold hover:underline">Cancel Request</button>
                </div>
            </div>
        </div>
    </main>
