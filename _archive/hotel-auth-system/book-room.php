...
<body class="bg-[#F8F5F0] min-h-screen">
    ...
    <div id="successModal" class="modal hidden fixed inset-0 z-[150] flex items-center justify-center p-6">
        ...
        <div class="bg-white rounded-[50px] w-full max-w-lg relative z-[151] overflow-hidden premium-shadow animate-up" style="animation: slideIn 0.6s ease-out forwards;">
            <!-- Pattern Header -->
            <div class="h-32 bg-[#6A1E2D] relative flex items-center justify-center" style="background: linear-gradient(135deg, #6A1E2D 0%, #832537 100%);">
                ...
                <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-2xl relative z-10">
                    <i class="fas fa-check text-[#2CA6A4] text-3xl"></i>
                </div>
            </div>

            <div class="p-10 text-center">
                <h3 class="text-3xl font-bold maroon-text mb-2">Residency Secured</h3>
                <p class="text-gray-400 text-sm mb-8">Your luxury residency has been officially archived.</p>

                <!-- Receipt Detail -->
                <div class="bg-gray-50 rounded-[32px] p-8 mb-8 border border-gray-100 relative text-left">
                    <div class="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#D4AF37] text-white text-[8px] font-black px-4 py-1 rounded-full uppercase tracking-widest">Official Receipt</div>
                    
                    <div class="space-y-4">
                        <div class="flex justify-between items-center border-b border-gray-100 pb-4">
                            <span class="text-[10px] uppercase font-bold text-gray-400 tracking-widest">Suite Selected</span>
                        ...
                        <div class="pt-4 border-t border-dashed border-[#D4AF37]/30 flex justify-between items-center">
                ...
                <div class="flex flex-col space-y-3">
                    <a href="customer-dashboard.php" class="w-full py-5 text-white rounded-2xl font-bold transition shadow-xl text-center" style="background: linear-gradient(135deg, #6A1E2D 0%, #832537 100%);">
            
                    </a>
                    <button onclick="window.location.reload()" class="text-[10px] uppercase font-bold text-gray-400 tracking-widest hover:text-[#D4AF37] transition">
        ...
        function completeBooking() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Show Success Modal
                    document.getElementById('successRooms').innerText = document.getElementById('modalRoomName').innerText;
                    document.getElementById('successCin').innerText = cin;
                    document.getElementById('successCout').innerText = cout;
                    document.getElementById('successTotal').innerText = document.getElementById('modalTotal').innerText;
